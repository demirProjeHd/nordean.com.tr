<section id="<?php echo e(__('messages.slugs.home')); ?>"
    ...
    <div class="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-24 z-10">
        <div class="max-w-3xl">
            ...
            <div class="flex flex-col sm:flex-row gap-4">
                <a href="#<?php echo e(__('messages.slugs.solutions')); ?>" class="nav-link inline-flex items-center justify-center gap-2 px-8 py-4 bg-primary text-white rounded-lg font-semibold hover:bg-primary/90 transition-all shadow-lg hover:shadow-xl">
                    <?php echo e(__('messages.hero.cta')); ?>

                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"/>
                    </svg>
                </a>
                <a href="#<?php echo e(__('messages.slugs.contact')); ?>" class="nav-link inline-flex items-center justify-center gap-2 px-8 py-4 bg-white/10 text-white rounded-lg font-semibold border-2 border-white hover:bg-white hover:text-gray-900 transition-all backdrop-blur-sm">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z"/>
                    </svg>
                    <?php echo e(__('messages.hero.contact')); ?>
...
<?php $__env->stopPush(); ?>
<?php /**PATH C:\xampp\htdocs\nordean.com.tr\resources\views/partials/hero.blade.php ENDPATH**/ ?>