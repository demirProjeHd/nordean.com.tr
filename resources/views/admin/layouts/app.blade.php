...
<head>
    ...
    <title>@yield('title', 'Admin Panel') - Nordean</title>
    ...
    <style>
        ...
        /* Dark sidebar logo fix - Override tabler default */
        [data-bs-theme=dark] .navbar-brand-autodark .navbar-brand-image {
            filter: none !important;
        }
        /* Logo size for sidebar */
            ...
            <div class="container-fluid">
                ...
                <h1 class="navbar-brand navbar-brand-autodark">
                    <a href="{{ route('admin.dashboard') }}">
                        <img src="{{ asset('images/nordean-logo.png') }}" height="32" alt="Nordean" class="navbar-brand-image">
                    </a>
                </h1>
                    ...
                    <ul class="navbar-nav pt-lg-3">
                        ...
                        <li class="nav-item">
                            <a class="nav-link {{ request()->routeIs('admin.sliders.*') ? 'active' : '' }}" href="{{ route('admin.sliders.index') }}">
                                ...
                                <span class="nav-link-title">Slaytlar</span>
                            </a>
                        </li>
                        <li class="nav-item">
                        ...
                        <li class="nav-item">
                            <a class="nav-link {{ request()->routeIs('admin.solutions.*') ? 'active' : '' }}" href="{{ route('admin.solutions.index') }}">
                                ...
                                <span class="nav-link-title">Çözümler</span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link {{ request()->routeIs('admin.references.*') ? 'active' : '' }}" href="{{ route('admin.references.index') }}">
                                <span class="nav-link-icon d-md-none d-lg-inline-block">
                                ...
                                <span class="nav-link-title">Referanslar</span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link {{ request()->routeIs('admin.pages.*') ? 'active' : '' }}" href="{{ route('admin.pages.index') }}">
                                ...
                                <span class="nav-link-title">Sayfa İçerikleri</span>
                            </a>
                        </li>
                        <li class="nav-item">
